...
const meta: Meta<typeof Divider> = {
  ...
  parameters: {
    design: {
      type: 'figma',
      url: 'https://www.figma.com/design/GhfBr6ptdMmkDrLpibdKqn/UI-Kit-All-Apps-Shadcn-Atoms?node-id=7622-76130&p=f&t=RS9jFsyUANIC05d3-0',
    },
    docs: {
      description: {
        component: `1px separator. \`orientation: horizontal\` for stacked sections · \`vertical\` for inline groups (e.g. between toolbar buttons).`,
      },
    },
  },
  argTypes: {
